...
export default function Contacts() {
  ...
  return (
    <div className="min-h-screen pt-16 pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <Helmet>
        <title>{language === 'ru' ? 'Контакты магазина парфюмерии АРХЕТИП в Гродно' : 'Кантакты крамы парфумерыі АРХЕТЫП у Гродне'} | АРХЕТИП</title>
        <meta 
          name="description" 
          content={language === 'ru' 
            ? 'Контакты интернет-магазина оригинальной парфюмерии АРХЕТИП в Гродно. Наш телефон, адрес студии парфюмерии, время работы, социальные сети и реквизиты для заказа духов и отливантов по всей Беларуси.' 
            : 'Кантакты інтэрнэт-крамы арыгінальнай парфумерыі АРХЕТЫП у Гродне. Наш тэлефон, адрас студыі парфумерыі, час працы, сацыяльныя сеткі і рэквізіты для замовы духоў і адлівантаў па ўсёй Беларусі.'} 
        />
        <meta property="og:title" content={language === 'ru' ? 'Контакты АРХЕТИП — парфюм в Гродно купить оригинал' : 'Кантакты АРХЕТЫП — парфюм у Гродне купіць арыгінал'} />
        <meta 
          property="og:description" 
          content={language === 'ru' 
            ? 'Адрес, телефон и реквизиты магазина оригинальных селективных духов и отливантов АРХЕТИП в Гродно.' 
            : 'Адрас, тэлефон і рэквізіты крамы арыгінальных селектыўных духоў і адлівантаў АРХЕТЫП у Гродне.'} 
        />
