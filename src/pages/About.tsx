...
export default function About() {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>{language === 'ru' ? 'О магазине парфюмерии АРХЕТИП в Гродно' : 'Пра краму парфумерыі АРХЕТЫП у Гродне'} | АРХЕТИП</title>
        <meta 
          name="description" 
          content={language === 'ru' 
            ? 'О компании АРХЕТИП — эксклюзивный интернет-магазин оригинальной парфюмерии в Гродно. У нас можно купить нишевые духи, туалетную воду и заказать оригинальный распив (отливанты) по всей Беларуси.' 
            : 'Пра кампанію АРХЕТЫП — эксклюзіўная інтэрнэт-крама арыгінальнай парфумерыі ў Гродне. У нас можна купіць нішавыя духі, туалетную ваду і замовіць арыгінальны распіў (адліванты) па ўсёй Беларусі.'} 
        />
        <meta property="og:title" content={language === 'ru' ? 'Магазин оригинальной парфюмерии АРХЕТИП в Гродно' : 'Крама арыгінальнай парфумерыі АРХЕТЫП у Гродне'} />
        <meta 
          property="og:description" 
          content={language === 'ru' 
            ? 'О компании АРХЕТИП — оригинальный парфюм, элитная парфюмерия, отливанты и тестеры в Гродно и РБ.' 
            : 'Пра кампанію АРХЕТЫП — арыгінальны парфюм, элітная парфумерыя, адліванты і тэстары ў Гродне і РБ.'} 
        />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://archetype.by/about" />
      </Helmet>
